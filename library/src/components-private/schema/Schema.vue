            ...
            .property-settings(v-if="!hideIndicators && attributes")
              ...
              .property-actions(v-else-if="!disableInteractions")
                NioSwitch(
                  ...
                  :check-child="checkChild(attribute,'deliverable')"
                  @click.stop=""
                ...
                NioSwitch(
                  ...
                  :check-child="checkChild(attribute,'filterable')"
                  @click.stop=""
...
import { setSelectionRecursively, getReadableType, replacePropertyRefs, getDataTypeIconName, isExportable, checkChild } from '../../modules/app/schema/attributeModule'
