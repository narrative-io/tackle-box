...
import { IconSubscriptions } from './icons/subscriptions'
...
const NioIconLibrary = {
	...
	"display-email": IconEmail,
	"display-website": IconWebsite,
	"display-security": IconSecurity,
	"display-privacy": IconPrivacy,
	"display-module": IconModule,
	"display-search": IconSearch,
	"display-notification": IconNotification,
	"display-subscriptions": IconSubscriptions,
	"display-hamburger": IconHamburger,
	"display-logout": IconLogout,
	"display-close": IconClose,
	"display-file": IconFile,
	"display-company": IconCompany,
	"display-cart": IconCart,
  ...
  "utility-folder-tree": ["fas", "folder-tree"],
	"utility-fingerprint": ["fas", "fingerprint"]
}
