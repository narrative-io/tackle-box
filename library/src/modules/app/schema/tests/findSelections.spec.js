import { findSelections, setSelectionRecursively, replacePropertyRefs } from '../attributeModule.js'
import { 
  Primitive,
	ArrayItemsPrimitive,
...
describe("findSelections", function() {
	beforeEach(function() {
  ...
  it("Primitive Attribute", function() {
		...
		let actual = findSelections(path, property, [], selectionType)
