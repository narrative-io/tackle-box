(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["tackle-box"] = factory(require("vue"));
	else
		root["tackle-box"] = factory(root["Vue"]);
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".jumbo-2{font-weight:600;font-size:64px;line-height:81px}.jumbo-1{font-weight:600;font-size:40px}.h1,h1{font-size:34px;line-height:43px}.h1,.h2,h1,h2{font-weight:600}.h2,h2{font-size:28px;line-height:36px}.h3,h3{font-weight:600;font-size:24px;line-height:30px;letter-spacing:.4px}.h4,h4{font-size:20px;line-height:26px}.h4,.h5,h4,h5{font-weight:600;letter-spacing:.8px}.h5,h5{font-size:16px;line-height:20px}.h6,h6{font-weight:600;font-size:12px;line-height:18px;letter-spacing:1.2px;text-transform:uppercase}.bold{font-weight:700}.body-large{font-weight:400;font-size:20px;line-height:32px;letter-spacing:.8px}.body{font-size:14px;line-height:24px}.body,.body-small{font-weight:400;letter-spacing:.6px}.body-small{font-size:12px;line-height:22px}.mono-small{font-family:\"Helvetica Monospaced Pro\";font-style:normal;font-weight:400;font-size:14px;line-height:26px}.button-label-small{font-size:14px;letter-spacing:1.6px;line-height:20px;font-weight:700;text-transform:uppercase}.text-primary-lightest{color:#f2f4fe}.text-primary-lighter{color:#bdcaf9}.text-primary-light{color:#849bf4}.text-primary{color:#0032e6}.text-primary-dark{color:#4b5fa7}.text-primary-darker{color:#031553}.text-primary-darkest{color:#010a28}.text-gray-lighter{color:#e6e6e6}.text-gray-light{color:#cecece}.text-gray-dark{color:#a1a1a1}.text-gray-darker{color:#626262}.text-black{color:#000}.text-white{color:#fff}.text-canvas{color:#f4f7fb}.text-footer{color:#ecf1f9}.text-turquoise-dark{color:#10668b}.text-turquoise-light{color:#08b5c4}.text-tangerine-dark{color:#ef7955}.text-tangerine-light{color:#f7afbb}.text-seagreen-dark{color:#4db26a}.text-seagreen-light{color:#68e08a}.text-purple-dark{color:#7d5d9d}.text-purple-light{color:#be93e8}.text-mustard-dark{color:#e0a340}.text-mustard-light{color:#fcecd2}.text-sand-dark{color:#9e9878}.text-sand-light{color:#e7e3ce}.text-success{color:#67ac5b}.text-alert{color:#4896ec}.text-warning{color:#f6c244}.text-error{color:#ff2054}.bg-primary-lightest{background-color:#f2f4fe}.bg-primary-lighter{background-color:#bdcaf9}.bg-primary-light{background-color:#849bf4}.bg-primary{background-color:#0032e6}.bg-primary-dark{background-color:#4b5fa7}.bg-primary-darker{background-color:#031553}.bg-primary-darkest{background-color:#010a28}.bg-gray-lighter{background-color:#e6e6e6}.bg-gray-light{background-color:#cecece}.bg-gray-dark{background-color:#a1a1a1}.bg-gray-darker{background-color:#626262}.bg-black{background-color:#000}.bg-white{background-color:#fff}.bg-canvas{background-color:#f4f7fb}.bg-footer{background-color:#ecf1f9}.bg-turquoise-dark{background-color:#10668b}.bg-turquoise-light{background-color:#08b5c4}.bg-tangerine-dark{background-color:#ef7955}.bg-tangerine-light{background-color:#f7afbb}.bg-seagreen-dark{background-color:#4db26a}.bg-seagreen-light{background-color:#68e08a}.bg-purple-dark{background-color:#7d5d9d}.bg-purple-light{background-color:#be93e8}.bg-mustard-dark{background-color:#e0a340}.bg-mustard-light{background-color:#fcecd2}.bg-sand-dark{background-color:#9e9878}.bg-sand-light{background-color:#e7e3ce}.bg-success{background-color:#67ac5b}.bg-alert{background-color:#4896ec}.bg-warning{background-color:#f6c244}.bg-error{background-color:#ff2054}.border-primary-lightest{border:2px solid #f2f4fe;border-radius:12px}.border-primary-lighter{border:2px solid #bdcaf9;border-radius:12px}.border-primary-light{border:2px solid #849bf4;border-radius:12px}.border-primary{border:2px solid #0032e6;border-radius:12px}.border-primary-dark{border:2px solid #4b5fa7;border-radius:12px}.border-primary-darker{border:2px solid #031553;border-radius:12px}.border-primary-darkest{border:2px solid #010a28;border-radius:12px}.border-gray-lighter{border:2px solid #e6e6e6;border-radius:12px}.border-gray-light{border:2px solid #cecece;border-radius:12px}.border-gray-dark{border:2px solid #a1a1a1;border-radius:12px}.border-gray-darker{border:2px solid #626262;border-radius:12px}.border-black{border:2px solid #000;border-radius:12px}.border-white{border:2px solid #fff;border-radius:12px}.border-canvas{border:2px solid #f4f7fb;border-radius:12px}.border-footer{border:2px solid #ecf1f9;border-radius:12px}.border-turquoise-dark{border:2px solid #10668b;border-radius:12px}.border-turquoise-light{border:2px solid #08b5c4;border-radius:12px}.border-tangerine-dark{border:2px solid #ef7955;border-radius:12px}.border-tangerine-light{border:2px solid #f7afbb;border-radius:12px}.border-seagreen-dark{border:2px solid #4db26a;border-radius:12px}.border-seagreen-light{border:2px solid #68e08a;border-radius:12px}.border-purple-dark{border:2px solid #7d5d9d;border-radius:12px}.border-purple-light{border:2px solid #be93e8;border-radius:12px}.border-mustard-dark{border:2px solid #e0a340;border-radius:12px}.border-mustard-light{border:2px solid #fcecd2;border-radius:12px}.border-sand-dark{border:2px solid #9e9878;border-radius:12px}.border-sand-light{border:2px solid #e7e3ce;border-radius:12px}.border-success{border:2px solid #67ac5b;border-radius:12px}.border-alert{border:2px solid #4896ec;border-radius:12px}.border-warning{border:2px solid #f6c244;border-radius:12px}.border-error{border:2px solid #ff2054;border-radius:12px}.nio-button{display:block;font-weight:600;font-size:.75rem;color:#fff;box-shadow:none;border-radius:2.5rem;letter-spacing:.6px;text-transform:none}.nio-button ::v-deep .v-btn__content{z-index:1}.nio-button.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#0032e6;color:#fff;border:1px solid #0032e6}.nio-button.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):focus{border:1px solid #0032e6}.nio-button.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):not(.v-btn--text):not(.v-btn--outlined):focus:before{opacity:0}.nio-button:hover.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#4b5fa7;border:1px solid #4b5fa7!important}.nio-button:disabled.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){opacity:.5!important;background-color:#0032e6!important;color:#fff!important;border:1px solid rgba(0,50,230,.5)!important;pointer-events:none;cursor:auto}.nio-button.v-btn--contained:active{box-shadow:none!important;background-color:#031553!important;border:1px solid #031553!important}.nio-button.v-btn:not(.v-btn--round).v-size--default{padding:0 30px;font-size:24px;height:52px}.nio-button.nio-button-primary.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#0032e6;color:#fff;border:1px solid #0032e6}.nio-button.nio-button-primary.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):focus{border:1px solid #0032e6}.nio-button.nio-button-primary.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):not(.v-btn--text):not(.v-btn--outlined):focus:before{opacity:0}.nio-button.nio-button-primary:hover.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#4b5fa7;border:1px solid #4b5fa7!important}.nio-button.nio-button-primary:disabled.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){opacity:.5!important;background-color:#0032e6!important;color:#fff!important;border:1px solid rgba(0,50,230,.5)!important;pointer-events:none;cursor:auto}.nio-button.nio-button-primary.v-btn--contained:active{box-shadow:none!important;background-color:#031553!important;border:1px solid #031553!important}.nio-button.nio-button-secondary.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#fff;border:1px solid #849bf4;color:#0032e6}.nio-button.nio-button-secondary.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):focus{border:1px solid #0032e6;background-color:#f4f7fb;color:#4b5fa7}.nio-button.nio-button-secondary.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):not(.v-btn--text):not(.v-btn--outlined):focus:before{opacity:0}.nio-button.nio-button-secondary:hover.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#f4f7fb;color:#4b5fa7;border:1px solid rgba(132,155,244,.5)}.nio-button.nio-button-secondary:disabled.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){opacity:.5!important;background-color:#f4f7fb!important;color:#0032e6!important;border:1px solid rgba(132,155,244,.5)!important;pointer-events:none;cursor:auto}.nio-button.nio-button-secondary:active{background-color:#fff!important;border:1px solid #849bf4!important;color:#0032e6!important}.nio-button.nio-button-selected{pointer-events:none;border:none}.nio-button.nio-button-selected.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#031553;color:#fff}.nio-button.nio-button-error.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#fff;border:1px solid #ff2054;color:#ff2054}.nio-button.nio-button-error.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):focus{background-color:#fff;color:#ff2054}.nio-button.nio-button-error.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined):not(.v-btn--text):not(.v-btn--outlined):focus:before{opacity:0}.nio-button.nio-button-error:hover.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){background-color:#f2f2f2;color:#ff3a68;border:1px solid #ff3a68}.nio-button.nio-button-error:disabled.theme--light.v-btn:not(.v-btn--flat):not(.v-btn--text):not(.v-btn--outlined){opacity:.5!important;border:1px solid rgba(255,32,84,.5)!important;pointer-events:none;cursor:auto}.nio-button.nio-button-error:active{background-color:#fff!important;border:1px solid #ff2054!important;color:#ff2054!important}.nio-button.nio-button-extra-large.v-btn:not(.v-btn--round).v-size--default{padding:0 30px;font-size:24px;height:52px}.nio-button.nio-button-large.v-btn:not(.v-btn--round).v-size--default{padding:0 28px;font-size:20px;height:44px}.nio-button.nio-button-normal.v-btn:not(.v-btn--round).v-size--default{padding:0 20px;font-size:16px;height:36px}.nio-button.nio-button-small.v-btn:not(.v-btn--round).v-size--default{padding:0 14px;font-size:14px;height:28px}.nio-button.nio-button-extra-small.v-btn:not(.v-btn--round).v-size--default{padding:0 10px;font-size:12px;height:24px}.nio-button.nio-button-caps{text-transform:uppercase}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"07858bee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/pug-plain-loader!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Button.vue?vue&type=template&id=7e696e24&lang=pug&
var Buttonvue_type_template_id_7e696e24_lang_pug_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-btn',{staticClass:"nio-button",class:[("nio-button-" + _vm.size), ("nio-button-" + _vm.variant), {'nio-button-caps': _vm.caps}],attrs:{"ripple":false},on:{"click":_vm.click}},[_vm._t("default")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Button.vue?vue&type=template&id=7e696e24&lang=pug&
...
var component = normalizeComponent(
  ...
  Buttonvue_type_template_id_7e696e24_lang_pug_render,
  staticRenderFns,
  false,
  null,
  null,
